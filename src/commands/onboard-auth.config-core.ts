...
export function applyModelverseProviderConfig(cfg: ClawdbotConfig): ClawdbotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyModelverseConfig(cfg: ClawdbotConfig): ClawdbotConfig {
